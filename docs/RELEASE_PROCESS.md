...
```text
xpam-script-v1.0.9-ubuntu24-debian12.tar.gz
```

Build:

```bash
tar -czf xpam-script-v1.0.9-ubuntu24-debian12.tar.gz xpam-script-v1.0.9
sha256sum xpam-script-v1.0.9-ubuntu24-debian12.tar.gz > xpam-script-v1.0.9-ubuntu24-debian12.tar.gz.sha256
```
...
```text
tag: v1.0.9
asset: xpam-script-v1.0.9-ubuntu24-debian12.tar.gz
asset: xpam-script-v1.0.9-ubuntu24-debian12.tar.gz.sha256
```
