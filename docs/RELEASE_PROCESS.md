...
```bash
tar -czf xpam-script-v1.0.6-ubuntu24-debian12.tar.gz xpam-script-v1.0.6
sha256sum xpam-script-v1.0.6-ubuntu24-debian12.tar.gz > xpam-script-v1.0.6-ubuntu24-debian12.tar.gz.sha256
```
...
```text
tag: v1.0.6
asset: xpam-script-v1.0.6-ubuntu24-debian12.tar.gz
asset: xpam-script-v1.0.6-ubuntu24-debian12.tar.gz.sha256
```
